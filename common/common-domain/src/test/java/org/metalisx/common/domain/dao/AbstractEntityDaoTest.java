...
public class AbstractEntityDaoTest extends TransactionRollbackTest {

	@Inject
	private DefaultEntityDao defaultEntityDao;
	...
	public static Archive<?> createTestArchive() {
		...
		// Domain
		        ...
		        // DAO's
		        AbstractDao.class, AbstractEntityDao.class,
                // Dto
	...
	public void testPersistAndFindById() {
		...
		user = defaultEntityDao.persist(UserAbstractEntity.class, user);
		assertNotNull(user.getId());

		UserAbstractEntity foundUser = defaultEntityDao.findById(UserAbstractEntity.class,
		        user.getId());
	...
	public void testRemove() {
		...
		defaultEntityDao.remove(UserAbstractEntity.class, user.getId());
		foundUser = defaultEntityDao.findById(UserAbstractEntity.class, user.getId());
