...
public class AbstractGenericDaoTest extends TransactionRollbackTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(JavaArchive.class, "test.jar").addClasses(
                // DAO's
                AbstractDao.class, AbstractGenericDao.class,
                // Dto
                ...
                // Test
                User.class,
                DefaultGenericDao.class, UserGenericDao.class,
    ...
    public void testPersist() {
        ...
        user = userGenericDao.persist(user);
        assertNotNull(user.getId());

        User foundUser = userGenericDao.findById(user.getId());
    ...
    public void testRemove() {
        ...
        userGenericDao.remove(user.getId());
        foundUser = userGenericDao.findById(user.getId());
