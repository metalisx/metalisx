...
public class AbstractEntityGenericDaoTest extends TransactionRollbackTest {

	@Inject
	private UserEntityGenericDao userEntityGenericDao;

	public AbstractEntityGenericDaoTest() {
	}
	...
	public void testPersistAndFindById() {
		...
		user = userEntityGenericDao.persist(user);
		assertNotNull(user.getId());

		UserAbstractEntity foundUser = userEntityGenericDao.findById(user.getId());
	...
	public void testRemove() {
		...
		userEntityGenericDao.remove(user.getId());
		foundUser = userEntityGenericDao.findById(user.getId());
