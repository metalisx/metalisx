...
public class JobManager {
    ...
    @Inject
    private Event<AuditData<String>> auditDataEvent;
	...
	public void enqueue(String message, int delay) {
        ...
        auditDataEvent.fire(new StringAuditData(LocalDateTime.now(), "Started " + job.getMessage()));
	}
	...
	public void dequeue(Job job) {
        ...
        auditDataEvent.fire(new StringAuditData(LocalDateTime.now(), "Ended " + job.getMessage()));
	}
